...
class MainActivityTest {
    ...
    fun mainActivityTest() {
        ...
        editText2.perform(replaceText("test automation engineer"))
        ...
        val textView2 = onView(
            allOf(
                withId(R.id.show_text_view), withText("test automation engineer"),
                withParent(
                    allOf(
                        withId(android.R.id.content),
        ...
        textView2.check(matches(withText("test automation engineer")))
    }
